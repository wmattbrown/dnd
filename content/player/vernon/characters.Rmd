...
Reduce(dplyr::bind_rows, 
       list(set_npc(name = "Vawen Lowwe'elai",
            ...
            set_npc("gnome",
                    "A gnome is in our party. I keep forgetting he's there and I can't remember his name. He doesn't talk much. He was a prisoner with the others and escaped with them. I should find out more about him."))) %>% 
  knitr::kable() %>% 
  kable_styling("striped", full_width = FALSE)# %>%
  # scroll_box(width = "100%")
